...
import { 
  ...
  ControlledTextField, ControlledNumberField, ControllerCurrencyField, ControllerPercentField,
  ControlledDatePicker, ControlledSelect, ControlledAutocomplete,
  ControllerCPFField, ControllerCNPJField, ControllerCEPField, ControllerPhoneBRField,
  zodBR
...
export const FullCustomerForm: Story = {
  render: () => {
    const { control, handleSubmit, watch, formState: { isSubmitting, errors } } = useForm<Customer>({
    ...
    const loadCities = async (input: string) => {
      ...
      const filtered = CITIES.filter(o => o.label.toLowerCase().includes(input.toLowerCase()));
        ...
        <FormLayout>
          ...
          <FormSection title="Basic info">
            ...
            <FormRow cols={{ xs:1, sm:2, md:2 }}>
              <ControlledNumberField control={control} name="income" label="Income" />
              <ControllerCurrencyField control={control} name="income" label="Income (Currency)" />
            </FormRow>
            <FormRow cols={{ xs:1, sm:2, md:2 }}>
          ...
          <FormSection title="Documents & Contact">
            ...
            <FormRow cols={{ xs:1, sm:2, md:2 }}>
              <ControllerPhoneBRField control={control} name="phone" label="Phone (BR)" />
